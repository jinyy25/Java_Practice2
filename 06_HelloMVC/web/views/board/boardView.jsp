<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.List,com.kh.board.model.vo.*"%>
<%@ page import="com.kh.board.model.vo.Board" %>
<%
	Board b=(Board)request.getAttribute("board");
	List<BoardComment> list=(List)request.getAttribute("comment");
%>
...
<style>
   ...
   div#comment-container input#btn-insert{width:60px;height:50px; color:white;
...
<section id="board-container">
		...
		<table id="tbl-board">
			...
			<tr>
				<th colspan="2">
					<button type="button" onclick="fn_move_list()">목록</button>
			...
			<script>
				function fn_move_list(){
					location.replace("<%=request.getContextPath()%>/board/boardList");
				}
   		...
   		<div id="comment-container">
   			<div class="comment-editor">
				<form action="<%=request.getContextPath() %>/board/boardCommentWrite" method="post">
